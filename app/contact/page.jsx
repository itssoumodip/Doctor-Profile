              ...
              <div className="space-y-4 animate-fade-in animation-delay-200">
                ...
                <div className="flex items-center gap-3 group">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">1. Dum Dum, Kolkata, West Bengal, India</p>
                    <p className="text-gray-600">2. Kalyani, Nadia, West Bengal, India</p>
                  </div>
                </div>
                <div className="flex items-center gap-3 group">
                  <div className="bg-blue-100 p-3 rounded-full group-hover:bg-blue-200 transition-colors duration-300">
              ...
              <div className="animate-fade-in animation-delay-400">
                ...
                <div className="bg-red-50 border-l-4 border-red-500 p-4">
                  <p className="text-gray-700">
                    For a medical emergency, please visit the nearest hospital.
                  </p>
                </div>
              </div>
            </div>
